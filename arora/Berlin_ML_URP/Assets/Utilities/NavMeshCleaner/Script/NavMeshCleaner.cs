// slightly modified to use NavMeshComponents instead of stock Unity NavMesh
    ...
    void Build()
    {
        ...
        for (int i = 0; i < m.Length || i == 0; i++)
        {
            ...
            if (i >= m_Child.Count)
            {
                ...
                NavMeshModifier modifier = o.AddComponent<NavMeshModifier>(); // for use with NavMeshComponents
                modifier.overrideArea = true;
                modifier.area = 1;
                //GameObjectUtility.SetNavMeshArea(o, 1); // for base Unity NavMesh
                m_Child.Add(o);
