Shader "Universal Render Pipeline/Nature/SpeedTree7 Billboard_Segmentation"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define ENABLE_WIND
            #include "..\Library\PackageCache\com.unity.render-pipelines.universal@7.3.1\Shaders\Nature\SpeedTree7BillboardInput.hlsl"
            #include "..\Library\PackageCache\com.unity.render-pipelines.universal@7.3.1\Shaders\Nature\SpeedTree7BillboardPasses.hlsl"
