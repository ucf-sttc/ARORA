Shader "Universal Render Pipeline/Nature/SpeedTree8_Segmentation"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "..\Library\PackageCache\com.unity.render-pipelines.universal@7.3.1\Shaders\Nature\SpeedTree8Input.hlsl"
            #include "..\Library\PackageCache\com.unity.render-pipelines.universal@7.3.1\Shaders\Nature\SpeedTree8Passes.hlsl"
